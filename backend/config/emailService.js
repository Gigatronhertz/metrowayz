      ...
      html: `
        ...
        <body>
          ...
          <div class="content">
            ...
            <center>
              <a href="${process.env.VITE_API_BASE_URL || 'https://metrowayz.vercel.app'}" class="button">Start Exploring</a>
            </center>
      ...
      html: `
        ...
        <body>
          ...
          <div class="content">
            ...
            <center>
              <a href="${process.env.VITE_API_BASE_URL || 'https://metrowayz.vercel.app'}/bookings" class="button">View My Bookings</a>
            </center>
...
const sendBookingNotificationToVendor = async (vendorEmail, bookingDetails) => {
  try {
      ...
      html: `
        ...
        <body>
          ...
          <div class="content">
            ...
            <center>
              <a href="${process.env.VITE_API_BASE_URL || 'https://metrowayz.vercel.app'}/vendor/bookings" class="button">View in Dashboard</a>
            </center>
    ...
    const info = await transporter.sendMail(mailOptions);
    console.log('Booking notification email sent to vendor:', info.messageId);
    return { success: true, messageId: info.messageId };
  } catch (error) {
